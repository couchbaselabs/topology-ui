...
function create_buckets_table_body_row(bucket) {
    ...
    "                                            <div class=\"flex flex-row px-6 py-1 text-xs text-white font-bold bg-blue-400 rounded-xl shadow-400 w-full\"><i class=\"fas fa-database\"><span class='px-2'>"+bucket.name+"</span></i></div>\n" +
    "                                        </td>\n" +
    "                                        <td class=\"px-2 py-2\">\n" +
...
function create_cluster(content, data) {
    // let config = extract_homogenous_resources(data);
