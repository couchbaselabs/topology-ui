...
function create_mobile_client(data) {
    ...
    return "                          <div class=\"flex-column max-w-100 py-2 my-0 space-y-0\">\n" +
        ...
        "                                                <image width=\"30\" height=\"40\" preserveAspectRatio=\"none\" xlink:href=\"/assets/couchbaselite.svg\" />\n" +
        "                                            </svg>\n" +
...
function create_os_icon(os) {
    return create_svg_icon("/assets/os-" + os + ".svg");
}
...
function create_sgwInstance(sgwData) {
    ...
    return create_instance(sgwData, create_svg("/assets/syncgateway.svg", height));
}
